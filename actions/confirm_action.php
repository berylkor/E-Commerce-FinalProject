<?php
    ...
    {
        // get the inputs for the payment table
        ...
        // check if the payment has been added to the table
        if ($addition !== false)
        {
            ...
            <body>";
                echo "<div class='invoice_container'>
            ...
            $email = $_SESSION['user_email']; // Assume the user's email is stored in the session
            ...
            try {
                ...
                $mail->Password = 'ezfp lcdy khas roav'; // Replace with your app-specific password
