...
{
	public function add_user($username, $email, $ppassword, $country)
	{
        ...
        $sql="INSERT INTO `users`(`user_name`, `user_email`, `user_pass`, `user_location`) VALUES ('$username','$email', '$hashpassword', '$country')";
